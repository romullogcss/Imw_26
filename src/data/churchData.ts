...
export const WEEKLY_SCHEDULE: ScheduleItem[] = [
  {
    ...
    description: 'Estudo aprofundado da Palavra de Deus em classes separadas por idades: Kids, Teens, Jovens e Adultos.',
    location: 'Salas da EBD / Templo',
    category: 'Estudo',
  },
  {
    id: 'dom-culto',
    day: 'Domingo',
    time: '18:00',
    title: 'Culto da Família & Celebração',
    description: 'Nosso culto principal com louvor abençoado, celebração da Ceia (1º domingo), mensagens inspiradoras e acolhimento.',
  ...
  },
  {
    ...
    description: 'Momento de intercessão pelas famílias, doentes e necessidades da igreja, seguido de estudo bíblico doutrinário.',
    location: 'Templo Principal',
    category: 'Oração',
    isHighlight: true,
  },
  {
    ...
    day: 'Quarta-feira',
    time: '15:00',
    title: 'Tarde da Esperança (Melhor Idade)',
    description: 'Encontro devocional e comunhão especial dedicada à terceira idade.',
  ...
  },
  {
    ...
    day: 'Quinta-feira',
    time: '19:30',
    title: 'Culto de Quinta-Feira (Doutrina & Vitória)',
    description: 'Culto presencial no meio da semana focado no fortalecimento espiritual, comunhão e busca ao Senhor.',
    location: 'Templo Principal',
    category: 'Culto',
    isHighlight: true,
  },
  {
    ...
    day: 'Sábado',
    time: '07:30',
    title: 'Café com Homens (1º e 3º Sábados)',
    description: 'Café da manhã de comunhão e fortalecimento espiritual para homens.',
    location: 'Salão Social',
    category: 'Reunião',
  },
  {
    ...
    description: 'Culto vibrante focado nos jovens e adolescentes, com louvor contemporâneo e palavra transformadora.',
    location: 'Templo Principal',
    category: 'Jovens',
    isHighlight: true,
  },
...
export const SPECIAL_EVENTS: ChurchEvent[] = [
  {
    id: 'ev-1',
    title: 'Conferência Anual de Famílias 2026',
    date: '24 e 25 de Setembro de 2026',
    time: 'A partir das 19h00',
    location: 'Templo Principal - IMW Cosmópolis',
    description: 'Dois dias de imersão no propósito divino para o lar, com pregações especiais, workshops para casais e programação infantil paralela.',
  ...
  {
    id: 'ev-2',
    title: 'Acampamento da Juventude Wesleyana',
    date: '12 a 15 de Outubro de 2026',
    time: 'Saída às 07h00 da Igreja',
    location: 'Recanto das Águas - Holambra/SP',
    description: 'Inscrições abertas para o melhor acampamento do ano! Louvor na fogueira, gincanas, ministração e momentos inesquecíveis.',
  ...
  {
    id: 'ev-3',
    title: 'Chá Especial de Primavera das Mulheres',
    date: '07 de Novembro de 2026',
    time: '16h00',
    location: 'Salão Social da Igreja',
    description: 'Uma tarde graciosa de comunhão, palestra sobre saúde emocional e espiritualidade feminina com convidada especial.',
    imageUrl: 'https://images.unsplash.com/photo-1528605248644-14dd04022da1?auto=format&fit=crop&q=80&w=800',
    badge: 'Evento Feminino',
  },
  {
    id: 'ev-4',
    title: 'EBF Kids - Escola Bíblica de Férias',
    date: '05 a 08 de Dezembro de 2026',
    time: '14h00 às 17h00',
    location: 'Espaço Kids IMW',
    description: 'Quatro dias super animados para crianças de 04 a 11 anos com o tema "Exploradores do Reino". Entrada gratuita com lanche.',
...
export const SERMONS_YOUTUBE: Sermon[] = [
  {
    id: 'sermon-1',
    title: 'Construindo a Vida Sobre a Rocha Inabalável',
    preacher: 'Pr. Carlos Eduardo Silva',
    date: '03 de Agosto de 2026',
    youtubeId: 'L_LUpnjgPso', // Generic YouTube inspirational worship/sermon video id
  ...
  },
  {
    ...
    category: 'Doutrina & História',
    thumbnail: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=800',
  },
  {
    id: 'sermon-4',
    title: 'Paz no Meio da Tempestade: Confiando nas Promessas',
    preacher: 'Pra. Ana Maria Silva',
    date: '13 de Julho de 2026',
    youtubeId: 'L_LUpnjgPso',
    youtubeUrl: 'https://www.youtube.com/embed/L_LUpnjgPso',
    duration: '39 min',
    scripture: 'Marcos 4:35-41',
  ...
  {
    id: 'sermon-5',
    title: 'Jovens com Propósito em uma Sociedade Distraída',
    preacher: 'Diácono Lucas Santos',
...
export const SPOTIFY_PLAYLIST = {
  embedUrl: 'https://open.spotify.com/embed/playlist/37i9dQZF1DX1fIAd60j023?utm_source=generator&theme=0',
  spotifyUrl: 'https://open.spotify.com',
  playlistTitle: 'Podcasts de Pregações & Louvores - IMW Cosmópolis',
  tracks: [
    {
      id: 'sp-1',
